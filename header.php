...
<!-- <header class="mt-5 ms-2"> -->
    <div class="row h-line d-flex justify-content-between">
        ...
        <div class="col-5 my-3 text-end">
            <ul class="list-unstyled">
                <li class="list-inline-item">
                    <a href="index.php" id="ac">Accueil</a>
                </li>
                <li class="list-inline-item">
        ...
        <div class="col-6 my-3">
            <div class="row">
                <div class="col">
                    <a href="index.php#location" id="ac">
                        <i class="fa fa-map-marker p-2 bd text-white" style="background-color: rgb(54, 160, 50);"><span class="px-2 text-white">Géolocation</span></i>
                    </a>
                </div>
                <div class="col-5">
                    <a href="publier_annonce.php" id="ac">
                        <i class="fa fa-bullhorn p-2 bd text-white" style="background-color: rgb(54, 160, 50);"><span class="px-2 text-white">Plublier une annonce</span></i>
                    </a>
                </div>
