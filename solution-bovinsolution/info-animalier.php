...
<head>
    <meta charset="utf-8">
    <title>Animalier Peulh BovinSolution | WaxangariLabs</title>
        ...
        <div class="container py-5">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="display-4 mb-4 mb-md-0 text-secondary text-uppercase">Animalier Peulh</h1>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn btn-sm btn-outline-light" href="../index.php">Accueil</a>
                        <i class="fas fa-angle-double-right text-light mx-2"></i>
                        <a class="btn btn-sm btn-outline-light" href="../service.php">Solution</a>
                        <i class="fas fa-angle-double-right text-light mx-2"></i>
                        <a class="btn btn-sm btn-outline-light disabled" href="">Animalier Peulh</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-5">
                        <h1 class="section-title mb-3">Descriptif sur la solution trouver des animaliers peulhs</h1>
                    </div>
                    <div class="mb-5">
                        <img class="img-fluid rounded w-100 mb-4" src="../img/img-peulh/animalier_peulh.jpg" style="height: 500px; object-fit: cover;" alt="Image">
                    ...
                    <div class="owl-carousel team-carousel position-relative">
                        <div class="team d-flex flex-column text-center rounded overflow-hidden">
                            ...
                            <div class="d-flex flex-column bg-primary text-center py-4">
                                ...
                                <p class="text-white m-0">Animalier</p>
                            </div>
                        </div>
                        <div class="team d-flex flex-column text-center rounded overflow-hidden">
                            <div class="position-relative">
