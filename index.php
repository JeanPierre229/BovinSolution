...
<body class="container">
    ...
    <main>
        <div class="row mt-3 bg">
            <div class="overlay col-lg-4 col-8 col-md-4 p-lg-5 p-md-5 p-5 mb-5 mb-lg-5 mb-md-5">
                <strong><h3 class="mb-lg-2 mb-md-2" style="color: rgb(54, 160, 50);">BovinSolution</h3></strong>
                <p class="h4 col-3 text-light mb-lg-5 mb-0 mb-md-5">
        ...
        <div class="row px-2" style="background-color: rgb(54, 160, 50);">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="container bg-light p-0" id="img-footer">
                        <p class="m-0">
                            <img src="images/vache.png" alt="L'élevage de boeufs" class="img-fluid col-12">
                        </p>
