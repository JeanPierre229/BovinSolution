        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Entrez ici...">
            </div>
          </div>
                        ...
                        <a class="chat-list-item p-h-25" href="javascript:void(0);">
                            <div class="media align-items-center">
                                <div class="avatar avatar-image">
                                    <img src="../../img/img-peulh/Man_Silhouette.png" alt="">
                                </div>
                                <div class="p-l-15">
                    ...
                    <div class="conversation">
                        <div class="conversation-wrapper">
                            ...
                            <div class="conversation-footer">
                                <input class="chat-input" type="text" placeholder="Entrez un message...">
