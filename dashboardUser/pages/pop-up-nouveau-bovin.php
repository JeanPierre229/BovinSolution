        ...
        <div class="pop-up-content">
          <div class="card">
            <div class="card-header text-start">
              <h5 class="card-title mb-0 text-center mb-2">Ajouter Un Nouvel Animal</h5>
              <form action="#" method="post">
                <div class="mb-3">
                  <label for="nom" class="form-label">Categorie du Nouvel Animal:</label>
                ...
                <div class="mb-3">
                    <label for="descriptionBovin" class="form-label">Description du bovin: </label>
                    <textarea name="descriptionBovin" class="form-control" placeholder="Faites une petite description..." id="descriptionBovin" cols="30" rows="3" required></textarea>
                </div>
                <div class="">
                    <div class="row">
                        <div class="col mt-3">
